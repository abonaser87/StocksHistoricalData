...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget = QtGui.QWidget(self.plotting)
        self.widget.setGeometry(QtCore.QRect(10, 11, 481, 224))
        ...
        self.btnPlot = QtGui.QPushButton(self.widget)
        self.btnPlot.setObjectName(_fromUtf8("btnPlot"))
        self.gridLayout_3.addWidget(self.btnPlot, 7, 0, 1, 1)
        self.verticalTabWidget.addTab(self.plotting, _fromUtf8(""))
        self.gridLayout_2.addWidget(self.verticalTabWidget, 0, 0, 1, 1)
    ...
    def on_Solve(self):
        ...
        self.s = DynamicSolver.DynamicSolver(self.dirpath, self.dyrfile, self.dllfile, self.casefile, fault, zone, self.tripBuses,self.tripType,self.statusBar)
        self.s.solve()
    def on_Plot(self):
